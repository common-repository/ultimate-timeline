...
<div class="row py-4 custom_image_upload">
    <div class="col-lg-6 mx-auto">
        ...
        <!-- Upload image input-->
        <div class="input-group mb-8 px-2 py-2 rounded-pill bg-white shadow-sm image_upload_div">
            ...
            <input id="custom_image_upload_id" type="hidden" value="<?php echo esc_attr($story_image_id) ?>" name="story_image_id" class="form-control border-0">
