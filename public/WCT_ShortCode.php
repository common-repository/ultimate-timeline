...
class WCT_ShortCode {
    ...
    public static function weblizar_timeline_custom_post_type() {
        $labels = array(
            'name'                => esc_html_x('Ultimate Timeline', 'ultimate-timeline'),
            'singular_name'       => esc_html_x('Ultimate Timeline', 'ultimate-timeline'),
        ...
        $args = array(
            'label'               => __('Ultimate Timeline', 'ultimate-timeline'),
            'labels'              => $labels,
            'description'         => __('Timeline Post Type Description', 'ultimate-timeline'),
